...
import { get_settlements } from "../../redux/payin/settlementReducer";

// btn obj takes name as name & function as func
const PayinSettlementTable = ({
  headers,
  tabledata,
  updateTable,
  btnObj,
  ...
  const { settlementData, successMessage, loader } = useSelector(
  ...
  useEffect(() => {
    if (successMessage) {
      setData(settlementData[0].documents);
    }
  }, [settlementData]);
...
export default PayinSettlementTable;
