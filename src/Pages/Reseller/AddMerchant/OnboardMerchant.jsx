...
import {
  createMerchant,
  messageClear,
} from "../../../redux/registeration/registerationReducer.js";
import { useSnackbar } from "notistack";
import { get_reseller_merchant } from "../../../redux/ResellerReducer/resellerReducer.js";

const OnboardMerchant = ({ setOpenModal }) => {
  const { resellerMerchant, successMessage, errorMessage, loader } =
    useSelector((state) => state.createmerchant);
  ...
  const onSubmitStepThree = async (values, resetForm) => {
    ...
    if (values.agree == false) {
      ...
      dispatch(createMerchant({ datax: formData, mode })).then(() => {
        resetForm();
        setOpenModal(false);
