...
import { get_reseller_merchant } from "../../redux/ResellerReducer/resellerReducer";
export const data = {
...
const ResellerDashboard = () => {
  const { resellerMerchant, payinTransaction } = useSelector(
        ...
        <div className="flex flex-row w-full  lg:gap-4 gap-8">
          <div className=" w-72    flex">
            <Dropdown
              ...
              dismissOnClick={true}
            >
              {resellerMerchant.length > 0 &&
                resellerMerchant.map((merchant, idx) => (
                  <Dropdown.Item
                    onClick={() => {
