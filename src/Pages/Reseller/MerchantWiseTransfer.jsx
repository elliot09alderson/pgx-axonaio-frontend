...
import {
  ...
  get_reseller_payout_transfer,
  get_reseller_payout_transfer_by_date,
...
const MerchantWiseTransfer = () => {
  ...
  useEffect(() => {
    if (startDate != null && endDate != null) {
      ...
      if (merchant?.m_id) {
        dispatch(get_reseller_payout_transfer({ id: merchant.m_id, mode }));
      }
    }
  ...
  function selectMerchant(m_id, name) {
    dispatch(get_reseller_payout_transfer({ id: m_id, mode }));
